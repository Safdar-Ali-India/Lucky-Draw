import styles from "./city2.module.css";
const City2 = () => {
  return (
    <div className={styles.city}>
      ...
      <div className={styles.top10}>
        ...
        <div className={styles.six}>
          <img className={styles.icon} alt="" src="/62.svg" />
        ...
        <div className={styles.five}>
          ...
          <div className={styles.tileComponent11}>
            <img className={styles.imageIcon10} alt="" src="/image11@2x.png" />
          </div>
        </div>
        ...
        <div className={styles.three}>
          ...
          <div className={styles.tileComponent11}>
            <img className={styles.imageIcon10} alt="" src="/image12@2x.png" />
          </div>
        </div>
        <div className={styles.two}>
          <img className={styles.icon4} alt="" src="/21.svg" />
          <div className={styles.tileComponent14}>
            <img className={styles.imageIcon10} alt="" src="/image13@2x.png" />
          </div>
        </div>
        <div className={styles.one}>
          <img className={styles.icon5} alt="" src="/11.svg" />
          <div className={styles.tileComponent11}>
            <img className={styles.imageIcon10} alt="" src="/image14@2x.png" />
          </div>
        </div>
      </div>
      ...
      <img className={styles.cityChild} alt="" src="/rectangle-893.svg" />
      ...
      <img className={styles.cityItem} alt="" src="/rectangle-894.svg" />
      <img className={styles.cityInner} alt="" src="/rectangle-895.svg" />
          ...
          <div className={styles.menuItems}>
            ...
            <div className={styles.iconnavigationarrowBackIosParent}>
              <img
                ...
                alt=""
                src="/iconnavigationarrow-back-ios-24px7.svg"
              />
