import styles from "./my-profile-groups-done.module.css";
const MyProfileGroupsDone = () => {
  return (
    <div className={styles.myProfileGroupsDone}>
      ...
      <div className={styles.myProfileGroupsDoneChild} />
...
export default MyProfileGroupsDone;
