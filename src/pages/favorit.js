    ...
    <div className={styles.favorit}>
      ...
      <div className={styles.sciFi}>
        <div className={styles.tileComponent}>
          <img className={styles.imageIcon} alt="" src="/image29@2x.png" />
        </div>
        ...
        <div className={styles.tileComponent4}>
          <img className={styles.imageIcon} alt="" src="/image33@2x.png" />
          <div className={styles.info}>
            <div className={styles.controlBar}>
              <div className={styles.controls}>
                <img className={styles.playIcon} alt="" />
      ...
      <div className={styles.trendingNow}>
        ...
        <div className={styles.tileComponent8}>
        ...
        <div className={styles.tileComponent9}>
      ...
      <div className={styles.top10}>
        ...
        <div className={styles.six}>
          ...
          <div className={styles.tileComponent10}>
            <img className={styles.imageIcon10} alt="" src="/image10@2x.png" />
          </div>
        </div>
        <div className={styles.five}>
          <img className={styles.icon1} alt="" src="/5.svg" />
          <div className={styles.tileComponent11}>
            <img className={styles.imageIcon10} alt="" src="/image39@2x.png" />
          </div>
          <b className={styles.appleWatch5}>Apple Watch</b>
        </div>
        <div className={styles.four}>
          <img className={styles.icon2} alt="" src="/4.svg" />
          <div className={styles.tileComponent10}>
            <img className={styles.imageIcon10} alt="" src="/image40@2x.png" />
          </div>
          <b className={styles.appleWatch6}>Apple Watch</b>
        </div>
        <div className={styles.three}>
          <img className={styles.icon3} alt="" src="/3.svg" />
          <div className={styles.tileComponent11}>
            <img className={styles.imageIcon10} alt="" src="/image41@2x.png" />
          </div>
          <b className={styles.appleWatch5}>Apple Watch</b>
        </div>
        <div className={styles.two}>
          ...
          <div className={styles.tileComponent14}>
            <img className={styles.imageIcon10} alt="" src="/image42@2x.png" />
          </div>
          <b className={styles.appleWatch8}>Apple Watch</b>
        </div>
        <div className={styles.one}>
          <img className={styles.icon5} alt="" src="/1.svg" />
          <div className={styles.tileComponent11}>
            <img className={styles.imageIcon10} alt="" src="/image43@2x.png" />
          </div>
          <b className={styles.appleWatch5}>Apple Watch</b>
        </div>
      </div>
      ...
      <img className={styles.favoritChild} alt="" src="/rectangle-8932.svg" />
