import styles from "./create-a-team1.module.css";
const CreateATeam1 = () => {
  return (
    <div className={styles.createATeam}>
      ...
      <div className={styles.signInParent}>
        <div className={styles.signIn}>
          ...
          <div className={styles.chooseAvatarParent}>
            <div className={styles.chooseAvatar}>Choose avatar</div>
      ...
      <div className={styles.addressCopyWrapper}>
        <div className={styles.addressCopy2}>
          <div className={styles.cardBg} />
        </div>
      </div>
    </div>
