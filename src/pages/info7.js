import styles from "./info7.module.css";
const Info7 = () => {
  return (
    <div className={styles.info7}>
      ...
      <div className={styles.info7Child} />
      <div className={styles.groupDiv}>
        <div className={styles.rectangleDiv} />
        <img
          className={styles.titleImageIcon1}
          alt=""
          src="/titleimage1@2x.png"
        />
        <img className={styles.imgIcon} alt="" src="/img1@2x.png" />
        <img className={styles.imgIcon1} alt="" src="/img2@2x.png" />
        <div className={styles.bgFade1} />
        <div className={styles.rectangleParent1}>
          <div className={styles.groupChild1} />
          <div className={styles.groupChild2} />
        </div>
        <div className={styles.findCousre}>Apple Watch</div>
        <div className={styles.findCousre1}>
        ...
        <img
          className={styles.vcsnormal934881Icon}
          alt=""
          src="/vcsnormal-93488-1.svg"
        />
        <img
          className={styles.vcsnormal934882Icon}
          alt=""
          src="/vcsnormal-93488-2.svg"
        />
      </div>
      <img
        className={styles.info7Item}
        alt=""
        src="/group-16865520301@2x.png"
      />
      <img
        className={styles.finalLuckyDodoVar01Icon1}
        alt=""
        src="/final-lucky-dodo-var01@2x.png"
      />
      <img
        ...
        alt=""
        src="/3643770favoriteheartlikelikesloveloved-113432-1.svg"
      />
    </div>
  );
};
